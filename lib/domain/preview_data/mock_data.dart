...
final mockUsers = [
  ...
  UserModel(
    ...
    featureRefs: ['feature4', 'feature4', 'feature4'],
    communitiesSubs: [
      '35321234-e3d1-47f5-a46d-86fd88890e79',
      '3e6e2e75-aa4f-4d6d-9520-0082016d72fd',
    ],
  ...
  UserModel(
    ...
    featureRefs: ['verified'],
    communitiesSubs: ['community_001'],
    friendsRefs: ['user_002', 'user_003', '1'],
    posted: ['post_001'],
